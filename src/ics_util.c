...
{
    int rcode = ITK_ok, expr_count = 1, options = ICS_SEARCH_THIS_CLASS_ONLY;
    int attr_ids[] = {ICS_UNCT_CID};
    char **attr_expr = NULL;
...
{
    int rcode = ITK_ok, child_count = 0;

    char **child_class_ids = NULL;
...
int ICS_UTIL_get_class_attr(const tag_t ico_tag, int *attr_count, char ***attr_names, char ***attr_values)
{
    ...
    int *attr_ids = NULL, *attr_val_counts = NULL;

    char ***attr_val_values = NULL;
